...
parser.add_argument("--epoch", type=int, default=724, help="epoch to start training from")
...
patch = (1, 70, 70) # patch = (1, 16, 16)
# patch = (1, opt.img_height // 2 ** 4, opt.img_width // 2 ** 4) # patch = (1, 16, 16)
# TODO: change the patch size to 70*70
